...
export interface ApiOrderyOrdery extends Struct.CollectionTypeSchema {
  collectionName: 'orderies';
  info: {
    displayName: 'ordery';
    pluralName: 'orderies';
    singularName: 'ordery';
  ...
  attributes: {
    ...
    shippingMethod: Schema.Attribute.Enumeration<
      ['office_delivery', 'home_delivery']
    >;
    shippingPrice: Schema.Attribute.Decimal;
    state: Schema.Attribute.String;
    statuis: Schema.Attribute.Enumeration<
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'privacy.privacy-policy', true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStateState extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Home_Delivery_Price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::state.state'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    Office_Delivery_Price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ordery.ordery': ApiOrderyOrdery;
